...
`notion-mesh-shard-pipe` is centered on distributed systems work in SQL. The technical target is: Implement an SQL distributed systems project for shard constraint solving, using bounded scenario files and conflict explanations.
